...
public class SearchParams2 {
        ...
        public SearchParams2(Long itemId, String thumbnail, String title, String address, String contentType, String intro, Double longitude, Double latitude, List<String> hashTagNames) {
            this.itemId = itemId;
