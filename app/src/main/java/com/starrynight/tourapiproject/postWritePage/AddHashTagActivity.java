...
public class AddHashTagActivity extends AppCompatActivity {
    ...
    public void ClickEvent(View view) {
        ...
        if(button.getTag() == "isClicked"){
            button.setTag("");
            button.setBackground(ContextCompat.getDrawable(this, R.drawable.hashtags_empty));
            ...
            button.setBackground(ContextCompat.getDrawable(this, R.drawable.hashtag_background));
